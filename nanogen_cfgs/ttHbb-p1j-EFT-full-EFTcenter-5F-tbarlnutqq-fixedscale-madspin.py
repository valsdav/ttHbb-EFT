...
# with command line options: Configuration/GenProduction/python/Hadronizer_TuneCP5_13TeV_generic_LHE_pythia8_PSweights_cff.py --python_filename ttHbb-EFT-full-BSScenter.py --eventcontent NANOAODGEN --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAOD --fileout file:test_eft.root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --step LHE,GEN,NANOGEN --geometry DB:Extended --era Run2_2016_HIPM --no_exec --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Hadronizer_TuneCP5_13TeV_generic_LHE_pythia8_PSweights_cff.py nevts:100'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:test_eft.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://eosuser.cern.ch//eos/user/d/dvalsecc/www/EFTstudies/gridpacks/ttHbb-p1j-signal-SMEFTsim-topU3l-5F-tbarlnutqq-madspin-fixedscale_EFTcenter_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
