...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://eosuser.cern.ch//eos/user/d/dvalsecc/www/EFTstudies/gridpacks/ttHbb-signal-SMEFTsim-topU3l_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
