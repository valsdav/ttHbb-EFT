...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://eosuser.cern.ch//eos/user/d/dvalsecc/www/EFTstudies/gridpacks/ttHbb-signal-SMEFTsim-topU3l-BSMcenter_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
