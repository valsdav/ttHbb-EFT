...
# with command line options: --python_filename recoAOD.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:recoAOD_step.root --conditions 106X_upgrade2018_realistic_v11_L1v1 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --geometry DB:Extended --filein file:digiRaw_step.root --era Run2_2018 --runUnscheduled --no_exec --mc -n 2000
