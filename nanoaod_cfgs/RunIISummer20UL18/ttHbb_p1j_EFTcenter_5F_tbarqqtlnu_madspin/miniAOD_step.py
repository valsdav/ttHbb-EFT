...
# with command line options: --python_filename miniAOD_step.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:miniAOD_step.root --conditions 106X_upgrade2018_realistic_v16_L1v1 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein file:recoAOD_step.root --era Run2_2018 --runUnscheduled --no_exec --mc -n 2000
