...
# with command line options: Configuration/GenProduction/python/Hadronizer_TuneCP5_13TeV_generic_LHE_pythia8_PSweights_cff.py --python_filename gensim_step.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:gensim.root --conditions 106X_upgrade2018_realistic_v11_L1v1 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int() --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 1
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Hadronizer_TuneCP5_13TeV_generic_LHE_pythia8_PSweights_cff.py nevts:1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:genSim_step.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        JetMatchingParameters = cms.vstring(
             ...
             'JetMatching:qCut = 19.',
             'JetMatching:nQmatch = 5',  # bquarks considered light jets
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://eosuser.cern.ch//eos/user/d/dvalsecc/www/EFTstudies/gridpacks/ttHbb-p1j-signal-SMEFTsim-topU3l-5F-tbarlnutqq-madspin_EFTcenter_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
