...
config.General.requestName = 'ttHbb_p1j_EFT_signal_EFTcenter_madspin'
config.General.workArea = 'crab_tasks'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = 'ttHbb-p1j-EFT-full-EFTcenter-madspin.py'
...
config.Data.outputDatasetTag = 'SMEFTsim_topU3l_EFT_madsping_reweightall_v1'
